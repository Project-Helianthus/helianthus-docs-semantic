...
Run `python3 scripts/validate_pack_metadata_v1.py`, `python3 scripts/test_validate_pack_metadata_v1.py`, then `./scripts/check_docs.sh`. The focused tests include source drift mutations, canonical-order rejection and deep-copy query isolation. They do not establish implementation, native qualification, Portal acceptance, interoperability or physical-device behavior.
